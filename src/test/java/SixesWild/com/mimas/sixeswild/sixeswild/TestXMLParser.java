...
public class TestXMLParser extends TestCase {
	...
	public void testXMLParserFileToLevel() {
		...
		PuzzleLevel level = (PuzzleLevel) XMLParser.fileToLevel("Test0.xml");
	...
	public void testXMLParserFileToLevelName() {
		String levelName = XMLParser.fileToLevelName("Test0.xml");
	...
	public void testXMLParserLevelToFile() {
		...
		try {
			...
			Level level2 = XMLParser.fileToLevel("Test1.xml");
