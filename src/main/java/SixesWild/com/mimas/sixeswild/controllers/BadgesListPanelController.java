...
/**
 * This class is the controller to handle what badges get drawn
 * when a selection is made in the badge submenu
 * 
 * @author MarcoDuran
 *
 */
public class BadgesListPanelController implements ActionListener {
	 ...
	 * 
	 * @param app The GameApplication that is currently running
	 */
